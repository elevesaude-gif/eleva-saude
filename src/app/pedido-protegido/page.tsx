...
export default function ProtectedOrderPage() {
  return (
    <main className={styles.page}>
      ...
      <section className={styles.trackingSection} aria-label="Acompanhar um pedido">
        <p>Seu pedido já foi enviado?</p>
        <Link className={styles.trackingCta} href="/rastreio">Rastrear meu pedido</Link>
      </section>
      ...
      <footer className={styles.footer}><BrandLogo negative size="small"/><p>Segurança, cuidado e transparência em cada etapa.</p><nav aria-label="Links finais"><Link href="/">Voltar para a página inicial</Link><Link href="/rastreio">Rastrear pedido</Link><a href="https://wa.me/5511920180233?text=Ol%C3%A1%21%20Preciso%20de%20ajuda%20com%20um%20pedido." target="_blank" rel="noopener noreferrer">Falar com atendimento</a></nav></footer>
    </main>
  );
}
